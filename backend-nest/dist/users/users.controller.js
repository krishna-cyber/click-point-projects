...
const change_user_role_dto_1 = require("./dto/change-user-role.dto");
...
let UsersController = class UsersController {
    ...
    findPermissionsOfModule(id, name) {
        if (!mongoose_1.Types.ObjectId.isValid(id)) {
            throw new common_1.BadRequestException('Invalid user id');
        }
    ...
    changeUserRole(updateUserRoledto, userId) {
...
__decorate([
    (0, common_1.Get)(':id/permission/:name'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Param)('name')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "findPermissionsOfModule", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [change_user_role_dto_1.UpdateUserRoledto, String]),
    __metadata("design:returntype", void 0)
